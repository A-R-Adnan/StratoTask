    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="flex justify-center mb-6">
          <button
            className={`px-4 py-2 font-semibold rounded-tl rounded-bl focus:outline-none ${
          ...
          <button
            className={`px-4 py-2 font-semibold rounded-tr rounded-br focus:outline-none ${
        ...
        <div className="mt-6 text-center">
          ...
          <button
            ...
            disabled={loading}
            className="flex justify-center items-center w-full border border-gray-300 rounded py-2 hover:bg-gray-100 transition disabled:opacity-50"
          >
            <svg
